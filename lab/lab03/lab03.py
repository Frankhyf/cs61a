...
def pingpong(n):
    ...
    '''if n<=8:
        return n 
    elif num_eights(n//10)>0:
        if num_eights(n-1)==0:
            return pingpong(n-1)-1
        else:
            return pingpong(n-2)
    elif num_eights(n//10-1)>0 and num_eights(n)==0
    elif n%10==9:
        return pingpong(n-1)-1
    elif (n//10-1)*10+8>=(n-1)//8*8 :  
        return pingpong((n//10-1)*10+8)-(n-((n//10-1)*10+8))
    elif (n//10-1)*10+8<(n-1)//8*8:
        return pingpong((n-1)//8*8)+n-(n-1)//8*8
    '''
